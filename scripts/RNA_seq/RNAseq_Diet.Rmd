...
```{r}
# extract the ditary intervention groups from the metadata
groups <- factor(metadata$diet_intervention)
```

```{r}
# create a data frame that includes the PCA results and group infomation
...
```{r}
#Create the "dds" object from count data and metadata. The experimental design compares high protein vs low protein. This is a design if you have only one variable to compare experimental groups.
